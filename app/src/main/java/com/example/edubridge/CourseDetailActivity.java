...
import com.example.edubridge.utils.AnalyticsManager; // Merged from Local
...
public class CourseDetailActivity extends AppCompatActivity {
    ...
    private void loadCourseData() {
        ...
        if (courseTitle != null) tvTitle.setText(courseTitle);
        if (desc != null) tvDesc.setText(desc);
        if (courseCategory != null) tvCategory.setText(courseCategory);
        if (difficulty != null) {
    ...
    private void loadDetailedInfo(String title, String category) {
        ...
        if (category != null && category.contains("Math")) {
            ...
            syllabus = Arrays.asList("Introduction to Variables", "Linear Equations", "Quadratic Functions", "Graphing Techniques", "Word Problems");
            ...
            syllabus = Arrays.asList("Scientific Method", "Forces and Motion", "Energy and Work", "Waves and Sound", "Light and Optics");
            ...
            syllabus = Arrays.asList("Getting Started", "Variables and Data Types", "Control Flow", "Functions", "OOP", "Building Your First App");
        } else {
            ...
            effort = "2-3 hrs/week";
            prerequisites = null;
            syllabus = Arrays.asList("Introduction", "Core Concepts", "Practical Applications", "Advanced Topics", "Final Project");
        }
    ...
    private void checkEnrollmentStatus() {
        EnrollmentManager.checkEnrollmentStatus(userId, courseId, (status, progress, enrolledAtTime) -> {
    ...
    private void showEnrolled() {
        ...
        if (syllabusAdapter != null) syllabusAdapter.notifyDataSetChanged();
    }
    ...
    private void enrollInCourse() {
        ...
        EnrollmentManager.enrollInCourse(userId, courseId, courseTitle, courseCategory, totalLessons,
    ...
    private void confirmUnenroll() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Are you sure you want to unenroll from \"" + courseTitle + "\"? Your progress will be lost.")
    ...
    private void unenrollFromCourse() {
        ...
        EnrollmentManager.unenrollFromCourse(userId, courseId, new EnrollmentManager.EnrollmentCallback() {
            @Override
            public void onSuccess(String message) {
                runOnUiThread(() -> {
                    Toast.makeText(CourseDetailActivity.this, message, Toast.LENGTH_SHORT).show();
    ...
    private void startLearning() {
        // Record Analytics (Merged from Local)
    ...
    private void setDifficultyColor(String difficulty) {
        ...
        switch (difficulty.toLowerCase()) {
            case "beginner": color = 0xFF4CAF50; break;
            case "intermediate": color = 0xFFFF9800; break;
            case "advanced": color = 0xFFF44336; break;
    ...
    private void setThumbnail(String category) {
        ...
        switch (category.toLowerCase()) {
            case "mathematics": resId = R.drawable.ic_subject_math; break;
            case "science": resId = R.drawable.ic_subject_science; break;
            case "coding": resId = R.drawable.ic_subject_coding; break;
            case "art": resId = R.drawable.ic_subject_art; break;
            case "geography": resId = R.drawable.ic_subject_geo; break;
            default: resId = R.drawable.ic_nav_library;
        }
